...
/* tagging */
static const char *tags[] = { "", "󰭹", "󰈹", "󰈙", "", "", "7", "8", "9" };
...
static const Key keys[] = {
	...
	{ 0, XF86XK_AudioRaiseVolume,	   spawn, 	   SHCMD("pamixer -u && pamixer -i 5")},
	{ 0, XF86XK_AudioLowerVolume,	   spawn, 	   SHCMD("pamixer -u && pamixer -d 5")},
